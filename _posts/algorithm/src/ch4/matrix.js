...
var SQUARE_MATRIX_MULITIPLY_Y_RECURSIVE = function (A, B) {
    ...
    if (n == 1) {
        ...
        var C12 = add_matrix(SQUARE_MATRIX_MULITIPLY_Y_RECURSIVE(A11,B12) ,SQUARE_MATRIX_MULITIPLY_Y_RECURSIVE(A12,B22))
        var C21 = add_matrix(SQUARE_MATRIX_MULITIPLY_Y_RECURSIVE(A21,B11) ,SQUARE_MATRIX_MULITIPLY_Y_RECURSIVE(A22,B21))
        var C22 = add_matrix(SQUARE_MATRIX_MULITIPLY_Y_RECURSIVE(A21,B12) ,SQUARE_MATRIX_MULITIPLY_Y_RECURSIVE(A22,B22))
